...
def run_position_monitor():
    ...
    try:
        ...
        # Fetch prices once — reuse for exit checks + sheets sync
        prices = {}
        ...
        # Run all exit checks (stop/target/trail/time) with fetched prices
        run_exit_checks(dry_run=False, prices=prices)
